...
| `API_KEY` | **Yes** | auto-generated by installer (`openssl rand -hex 32`) | Secret key required on all API requests (`x-api-key` header). Must be set manually for non-installer deployments. |
